...
class PaginatedMessageList(object):

    """Implementation of the 'PaginatedMessageList' model.
    ...
    Attributes:
        ...
        results (list of Message): TODO: type description here.
    ...
    def __init__(self,
                 ...
                 previous=None,
                 results=None):
        """Constructor for the PaginatedMessageList class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('results') is not None:
            results = [Message.from_dictionary(x) for x in dictionary.get('results')]
