...
class PaginatedVerificationDocumentList(object):

    """Implementation of the 'PaginatedVerificationDocumentList' model.
    ...
    Attributes:
        ...
        results (list of VerificationDocument): TODO: type description here.
    ...
    def __init__(self,
                 ...
                 previous=None,
                 results=None):
        """Constructor for the PaginatedVerificationDocumentList class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('results') is not None:
            results = [VerificationDocument.from_dictionary(x) for x in dictionary.get('results')]
