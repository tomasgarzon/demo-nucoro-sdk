...
class PaginatedTaxInformationListList(object):

    """Implementation of the 'PaginatedTaxInformationListList' model.
    ...
    Attributes:
        ...
        results (list of TaxInformationList): TODO: type description here.
    ...
    def __init__(self,
                 ...
                 previous=None,
                 results=None):
        """Constructor for the PaginatedTaxInformationListList class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('results') is not None:
            results = [TaxInformationList.from_dictionary(x) for x in dictionary.get('results')]
