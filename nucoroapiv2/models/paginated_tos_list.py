...
class PaginatedTosList(object):

    """Implementation of the 'PaginatedTosList' model.
    ...
    Attributes:
        ...
        results (list of Tos): TODO: type description here.
    ...
    def __init__(self,
                 ...
                 previous=None,
                 results=None):
        """Constructor for the PaginatedTosList class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('results') is not None:
            results = [Tos.from_dictionary(x) for x in dictionary.get('results')]
