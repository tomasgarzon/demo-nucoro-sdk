...
class PaginatedClientDetailList(object):

    """Implementation of the 'PaginatedClientDetailList' model.
    ...
    Attributes:
        ...
        results (list of ClientDetail): TODO: type description here.
    ...
    def __init__(self,
                 ...
                 previous=None,
                 results=None):
        """Constructor for the PaginatedClientDetailList class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('results') is not None:
            results = [ClientDetail.from_dictionary(x) for x in dictionary.get('results')]
