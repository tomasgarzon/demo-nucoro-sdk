...
class PaginatedWatchlistList(object):
    ...
    """Implementation of the 'PaginatedWatchlistList' model.
    ...
    Attributes:
        ...
        results (list of Watchlist): TODO: type description here.
    ...
    def __init__(self,
                 ...
                 previous=None,
                 results=None):
        """Constructor for the PaginatedWatchlistList class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('results') is not None:
            results = [Watchlist.from_dictionary(x) for x in dictionary.get('results')]
