...
class PaginatedRebalanceList(object):

    """Implementation of the 'PaginatedRebalanceList' model.
    ...
    Attributes:
        ...
        results (list of Rebalance): TODO: type description here.
    ...
    def __init__(self,
                 ...
                 previous=None,
                 results=None):
        """Constructor for the PaginatedRebalanceList class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('results') is not None:
            results = [Rebalance.from_dictionary(x) for x in dictionary.get('results')]
