...
class PaginatedVerificationListList(object):

    """Implementation of the 'PaginatedVerificationListList' model.
    ...
    Attributes:
        ...
        results (list of VerificationList): TODO: type description here.
    ...
    def __init__(self,
                 ...
                 previous=None,
                 results=None):
        """Constructor for the PaginatedVerificationListList class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('results') is not None:
            results = [VerificationList.from_dictionary(x) for x in dictionary.get('results')]
