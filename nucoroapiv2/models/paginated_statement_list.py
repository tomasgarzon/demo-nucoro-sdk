...
class PaginatedStatementList(object):

    """Implementation of the 'PaginatedStatementList' model.
    ...
    Attributes:
        ...
        results (list of Statement): TODO: type description here.
    ...
    def __init__(self,
                 ...
                 previous=None,
                 results=None):
        """Constructor for the PaginatedStatementList class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('results') is not None:
            results = [Statement.from_dictionary(x) for x in dictionary.get('results')]
