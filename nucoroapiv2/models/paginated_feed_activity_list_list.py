...
class PaginatedFeedActivityListList(object):

    """Implementation of the 'PaginatedFeedActivityListList' model.
    ...
    Attributes:
        ...
        results (list of FeedActivityList): TODO: type description here.
    ...
    def __init__(self,
                 ...
                 previous=None,
                 results=None):
        """Constructor for the PaginatedFeedActivityListList class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('results') is not None:
            results = [FeedActivityList.from_dictionary(x) for x in dictionary.get('results')]
