...
class PaginatedInvestorFeeList(object):

    """Implementation of the 'PaginatedInvestorFeeList' model.
    ...
    Attributes:
        ...
        results (list of InvestorFee): TODO: type description here.
    ...
    def __init__(self,
                 ...
                 previous=None,
                 results=None):
        """Constructor for the PaginatedInvestorFeeList class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('results') is not None:
            results = [InvestorFee.from_dictionary(x) for x in dictionary.get('results')]
