...
class PaginatedInvoiceListList(object):

    """Implementation of the 'PaginatedInvoiceListList' model.
    ...
    Attributes:
        ...
        results (list of InvoiceList): TODO: type description here.
    ...
    def __init__(self,
                 ...
                 previous=None,
                 results=None):
        """Constructor for the PaginatedInvoiceListList class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('results') is not None:
            results = [InvoiceList.from_dictionary(x) for x in dictionary.get('results')]
