...
class PaginatedBankAccountListList(object):

    """Implementation of the 'PaginatedBankAccountListList' model.
    ...
    Attributes:
        ...
        results (list of BankAccountList): TODO: type description here.
    ...
    def __init__(self,
                 ...
                 previous=None,
                 results=None):
        """Constructor for the PaginatedBankAccountListList class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('results') is not None:
            results = [BankAccountList.from_dictionary(x) for x in dictionary.get('results')]
