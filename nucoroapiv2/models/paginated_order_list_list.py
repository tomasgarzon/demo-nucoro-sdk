...
class PaginatedOrderListList(object):

    """Implementation of the 'PaginatedOrderListList' model.
    ...
    Attributes:
        ...
        results (list of OrderList): TODO: type description here.
    ...
    def __init__(self,
                 ...
                 previous=None,
                 results=None):
        """Constructor for the PaginatedOrderListList class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('results') is not None:
            results = [OrderList.from_dictionary(x) for x in dictionary.get('results')]
