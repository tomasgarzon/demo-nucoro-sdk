...
class PaginatedGoalList(object):

    """Implementation of the 'PaginatedGoalList' model.
    ...
    Attributes:
        ...
        results (list of Goal): TODO: type description here.
    ...
    def __init__(self,
                 ...
                 previous=None,
                 results=None):
        """Constructor for the PaginatedGoalList class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('results') is not None:
            results = [Goal.from_dictionary(x) for x in dictionary.get('results')]
