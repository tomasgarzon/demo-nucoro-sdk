...
class PaginatedAddressListList(object):

    """Implementation of the 'PaginatedAddressListList' model.
    ...
    Attributes:
        ...
        results (list of AddressList): TODO: type description here.
    ...
    def __init__(self,
                 ...
                 previous=None,
                 results=None):
        """Constructor for the PaginatedAddressListList class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('results') is not None:
            results = [AddressList.from_dictionary(x) for x in dictionary.get('results')]
