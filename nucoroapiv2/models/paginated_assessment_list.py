...
class PaginatedAssessmentList(object):

    """Implementation of the 'PaginatedAssessmentList' model.
    ...
    Attributes:
        ...
        results (list of Assessment): TODO: type description here.
    ...
    def __init__(self,
                 ...
                 previous=None,
                 results=None):
        """Constructor for the PaginatedAssessmentList class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('results') is not None:
            results = [Assessment.from_dictionary(x) for x in dictionary.get('results')]
