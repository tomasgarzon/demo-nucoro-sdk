...
class PaginatedPriceList(object):

    """Implementation of the 'PaginatedPriceList' model.
    ...
    Attributes:
        ...
        results (list of Price): TODO: type description here.
    ...
    def __init__(self,
                 ...
                 previous=None,
                 results=None):
        """Constructor for the PaginatedPriceList class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('results') is not None:
            results = [Price.from_dictionary(x) for x in dictionary.get('results')]
