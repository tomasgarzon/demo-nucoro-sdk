...
class PaginatedCategoryList(object):

    """Implementation of the 'PaginatedCategoryList' model.
    ...
    Attributes:
        ...
        results (list of Category): TODO: type description here.
    ...
    def __init__(self,
                 ...
                 previous=None,
                 results=None):
        """Constructor for the PaginatedCategoryList class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('results') is not None:
            results = [Category.from_dictionary(x) for x in dictionary.get('results')]
