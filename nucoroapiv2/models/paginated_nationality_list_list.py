...
class PaginatedNationalityListList(object):

    """Implementation of the 'PaginatedNationalityListList' model.
    ...
    Attributes:
        ...
        results (list of NationalityList): TODO: type description here.
    ...
    def __init__(self,
                 ...
                 previous=None,
                 results=None):
        """Constructor for the PaginatedNationalityListList class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('results') is not None:
            results = [NationalityList.from_dictionary(x) for x in dictionary.get('results')]
