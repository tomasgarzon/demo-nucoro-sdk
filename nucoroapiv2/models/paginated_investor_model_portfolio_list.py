...
class PaginatedInvestorModelPortfolioList(object):

    """Implementation of the 'PaginatedInvestorModelPortfolioList' model.
    ...
    Attributes:
        ...
        results (list of InvestorModelPortfolio): TODO: type description
            here.
    ...
    def __init__(self,
                 ...
                 previous=None,
                 results=None):
        """Constructor for the PaginatedInvestorModelPortfolioList class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('results') is not None:
            results = [InvestorModelPortfolio.from_dictionary(x) for x in dictionary.get('results')]
