...
class PatchedApplicationClientUpdate(object):

    """Implementation of the 'PatchedApplicationClientUpdate' model.
    ...
    def __init__(self,
        ...
        """Constructor for the PatchedApplicationClientUpdate class"""
