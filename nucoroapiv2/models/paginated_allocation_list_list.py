...
class PaginatedAllocationListList(object):

    """Implementation of the 'PaginatedAllocationListList' model.
    ...
    Attributes:
        ...
        results (list of AllocationList): TODO: type description here.
    ...
    def __init__(self,
                 ...
                 previous=None,
                 results=None):
        """Constructor for the PaginatedAllocationListList class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('results') is not None:
            results = [AllocationList.from_dictionary(x) for x in dictionary.get('results')]
